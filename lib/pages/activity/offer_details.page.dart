...
import 'package:nexnet/pages/order/order_success_page.dart';
import 'package:nexnet/services/auth/auth_services.dart';
import 'package:nexnet/services/cloud/cloud_custom_offer/cloud_custom_offer.dart';
import 'package:nexnet/services/cloud/cloud_custom_offer/cloud_custom_offer_service.dart';
...
class _OfferDetailsPageState extends State<OfferDetailsPage> {
  ...
  Future<void> createOrder() async {
    ...
    await CloudCustomOfferService.firebase()
        .deleteOffer(widget.cloudOrder.orderId);
  }
