...
import 'package:nexnet/pages/gig_details/gig_details_page.dart';
import 'package:nexnet/services/cloud/cloud_gig/cloud_gig.dart';
import 'package:nexnet/services/cloud/cloud_gig/cloud_gig_service.dart';
        ...
        switch (snapshot.connectionState) {
          case ConnectionState.active:
            if (snapshot.hasData) {
              ...
              return const Center(
                child: Text('No Recommendation',style: TextStyle(
